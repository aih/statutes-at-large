...
0026 a deploy skips a documentation-only change, 0027 Contents open, a lone
section shown on its parent's page, and the note's source sentence). A BUILDLOG entry per session. Verification counts in `docs/verification/`
