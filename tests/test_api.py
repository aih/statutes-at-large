...
def test_status(client):
    ...
    assert statute["volumes"] == [64, 72, 124, 137]
    assert statute["packages_loaded"] == 4 and statute["latest_package"] == "STATUTE-137"
    assert statute["laws"] == 22 and statute["units"] > 0 and statute["latest_loaded_at"]
